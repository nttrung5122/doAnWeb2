    ...
    <div class="modal" id="form_alterTest" tabindex="-1" aria-labelledby="popupLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="popupLabel">Sửa đề kiểm tra</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <!-- Nội dung của pop-up -->
                <div class="modal-body">
                <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="txtNameTest_alter" >
                        <label for="txtNameTest_alter">Tên bài kiểm tra</label>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <input type="datetime-local" class="form-control" name="ngayThi" id="ngayThi_alter">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="btnAltertest">Tiếp tục</button>
