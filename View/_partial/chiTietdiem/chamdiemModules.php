<?php
class chamdiemModules
{
    public static function cauDung($socau, $dapan)
    {
        return '
        <div class="hstack gap-3 mb-2 bg-success bg-opacity-25 text-black p-3">
            <div class="fs-4 fw-bold">Câu ' . $socau . ':</div>
            <div class="ms-auto fs-4 fw-bold" style="width: 3rem;">' . $dapan . '</div>
            <!-- icon -->
    ...
    public static function cauSai($socau, $dapan)
    {
        return '
