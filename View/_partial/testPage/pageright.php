<head>
    ...
    <?php include 'themCauhoi_vaoTable.php'; ?>
    <style>
        table thead,
        table tfoot {
            position: sticky;
...
<body>
    ...
    <div class="table-responsive" style="height: 700px;">
        <table class="table table-hover align-middle" id="bangCauhoi">
            ...
            <tbody>
                ...
                <?php
                themcauhoiModules::themCauhoi(1, 'Bò không ăn cỏ', 'Nông nghiệp');
                themcauhoiModules::themCauhoi(2, 'Gạch và đá', 'Xây dựng');
                themcauhoiModules::themCauhoi(3, 'Java là gì?', 'Công nghệ thông tin');
                themcauhoiModules::themCauhoi(4, 'Có 1 đàn chim đậu trên cành, người thợ săn bắn cái rằm. Hỏi chết mấy con?', 'Hài hước');
                ?>
            </tbody>
        </table>
    </div>
    ...
    <div class="d-grid gap-2 col-2 mx-auto">
        <button class="btn btn-primary mt-3" type="button">Lưu lại</button>
    </div>
    <!-- </div> -->
</body>